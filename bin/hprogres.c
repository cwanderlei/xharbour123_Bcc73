 ...
 * Generated C source code from <D:\\hwgui_2_17\\source\\hprogres.prg>
 * Command: -ohprogres.c -m -n -p -q -gc0 -ID:\hwgui_2_17\include -ID:\xharbour123_Bcc73\include D:\hwgui_2_17\source\hprogres.prg 
...
#define __PRG_SOURCE__ "D:\\hwgui_2_17\\source\\hprogres.prg"
...
HB_FUNC_EXTERN( HWG_MODIFYSTYLE );
...
{ "HWG_MODIFYSTYLE", {HB_FS_PUBLIC}, {HB_FUNCNAME( HWG_MODIFYSTYLE )}, NULL },
...
HB_FUNC_STATIC( HPROGRESSBAR_NEWBOX )
{
   static const BYTE pcode[] =
   {
	...
	100,100,9,112,25,112,1,73,134,21,48,49,0,95,
	10,48,2,0,108,50,100,12,0,100,100,122,48,51,
	0,95,10,112,0,95,3,128,5,0,48,52,0,95,
	10,112,0,92,19,108,53,100,95,9,12,1,28,7,
	106,1,0,25,6,106,2,37,0,100,100,100,100,100,
	100,100,112,15,112,1,73,48,54,0,48,55,0,95,
	10,112,0,106,11,58,58,76,97,98,101,108,66,111,
	120,0,112,1,73,134,23,95,8,100,69,28,19,134,
	24,48,56,0,48,57,0,95,10,112,0,95,8,112,
	1,73,134,27,48,42,0,48,57,0,95,10,112,0,
	120,100,100,112,3,73,134,29,48,58,0,95,10,48,
	59,0,95,10,112,0,112,1,73,134,30,48,60,0,
	95,10,121,112,1,73,134,31,48,42,0,95,10,112,
	0,73,134,32,48,61,0,48,57,0,95,10,112,0,
	95,10,112,1,73,134,34,95,10,110,7
   };
...
HB_FUNC_STATIC( HPROGRESSBAR_ACTIVATE )
{
   static const BYTE pcode[] =
   {
	...
	3,48,66,0,95,1,112,0,73,134,6,100,110,7
   };
...
HB_FUNC_STATIC( HPROGRESSBAR_INIT )
{
   static const BYTE pcode[] =
   {
	13,1,0,102,80,1,133,111,0,48,67,0,95,1,
...
HB_FUNC_STATIC( HPROGRESSBAR_STEP )
{
   static const BYTE pcode[] =
   {
	13,1,1,102,80,2,133,122,0,48,70,0,95,2,
...
HB_FUNC_STATIC( HPROGRESSBAR_SET )
{
   static const BYTE pcode[] =
   {
	13,1,2,102,80,3,133,138,0,95,1,100,69,28,
...
HB_FUNC_STATIC( HPROGRESSBAR_SETLABEL )
{
   static const BYTE pcode[] =
   {
	13,1,1,102,80,2,133,149,0,9,95,1,100,69,
...
HB_FUNC_STATIC( HPROGRESSBAR_SETANIMATION )
{
   static const BYTE pcode[] =
   {
	13,1,1,102,80,2,133,157,0,95,1,100,69,29,
	...
	11,48,33,0,95,2,95,1,112,1,73,134,14,48,
...
HB_FUNC_STATIC( HPROGRESSBAR_CLOSE )
{
   static const BYTE pcode[] =
   {
	13,1,0,102,80,1,133,175,0,108,21,100,48,15,

 ...
 * Generated C source code from <D:\\hwgui_2_17\\source\\printdos.prg>
 * Command: -oprintdos.c -m -n -p -q -gc0 -ID:\hwgui_2_17\include -ID:\xharbour123_Bcc73\include D:\hwgui_2_17\source\printdos.prg 
 * Created: 2022.04.18 15:41:31 (Borland/Embarcadero C++ 7.3 (32-bit))
 */

#include "hbvmpub.h"
#include "hbinit.h"

#define __PRG_SOURCE__ "D:\\hwgui_2_17\\source\\printdos.prg"
...
{ "HWG_WPROW", {HB_FS_PUBLIC | HB_FS_LOCAL | HB_FS_FIRST}, {HB_FUNCNAME( HWG_WPROW )}, &ModuleFakeDyn },
{ "HWG_WPCOL", {HB_FS_PUBLIC | HB_FS_LOCAL}, {HB_FUNCNAME( HWG_WPCOL )}, &ModuleFakeDyn },
{ "HWG_WSETPRC", {HB_FS_PUBLIC | HB_FS_LOCAL}, {HB_FUNCNAME( HWG_WSETPRC )}, &ModuleFakeDyn },
...
{ "HWG_REGENFILE", {HB_FS_PUBLIC | HB_FS_LOCAL}, {HB_FUNCNAME( HWG_REGENFILE )}, &ModuleFakeDyn },
...
HB_FUNC( HWG_WPROW )
{
   static const BYTE pcode[] =
   {
	13,0,1,133,108,1,48,85,0,95,1,112,0,110,
	7
   };
...
HB_FUNC( HWG_WPCOL )
{
   static const BYTE pcode[] =
   {
	13,0,1,133,112,1,48,70,0,95,1,112,0,110,
	7
   };
...
HB_FUNC( HWG_WSETPRC )
{
   static const BYTE pcode[] =
   {
	13,0,3,133,116,1,48,98,0,95,3,95,1,95,
...
HB_FUNC_STATIC( PRINTDOS_TXTTOGRAPHIC )
{
   static const BYTE pcode[] =
   {
	13,8,3,102,80,4,133,121,1,108,88,100,93,4,
...
HB_FUNC_STATIC( PRINTDOS_PREVIEW )
{
   static const BYTE pcode[] =
   {
	13,15,2,102,80,3,133,176,1,108,88,100,93,4,
	8,12,1,80,5,126,6,4,8,134,1,108,92,100,
	...
	112,16,73,48,2,0,108,123,100,12,0,100,100,95,
	10,122,5,28,9,97,0,0,0,8,25,3,121,92,
	6,92,80,92,69,92,32,106,3,62,62,0,100,100,
	100,100,89,28,0,1,0,3,0,9,0,10,0,12,
	0,108,125,100,95,255,95,254,95,253,12,3,21,80,
	254,6,100,100,100,112,16,73,48,2,0,108,123,100,
	12,0,100,100,100,92,6,93,130,0,92,69,92,32,
	106,9,73,109,112,114,105,109,105,114,0,100,100,100,
	100,89,21,0,1,0,2,0,12,0,17,0,108,126,
	100,95,255,95,254,12,2,6,100,100,100,112,16,73,
	48,2,0,108,123,100,12,0,100,100,100,92,6,93,
	230,0,92,69,92,32,106,7,70,101,99,104,97,114,
	0,100,100,100,100,89,13,0,1,0,0,0,108,127,
	100,12,0,6,100,100,100,112,16,73,48,128,0,95,
	13,112,0,73,134,69,120,110,7
   };
...
HB_FUNC_STATIC( PRINTDOSPRINT )
{
   static const BYTE pcode[] =
   {
	13,2,2,133,249,1,108,60,100,95,2,12,1,80,
...
HB_FUNC_STATIC( PRINTDOSANT )
{
   static const BYTE pcode[] =
   {
	13,1,2,133,2,2,108,129,100,12,0,80,3,134,
...
HB_FUNC_STATIC( PRINTDOSNEXT )
{
   static const BYTE pcode[] =
   {
	13,1,3,133,13,2,108,129,100,12,0,80,4,134,
...
HB_FUNC( HWG_REGENFILE )
{
   static const BYTE pcode[] =
   {
	13,6,2,133,21,2,108,132,100,95,1,12,1,80,
...
#line 561 "D:\\hwgui_2_17\\source\\printdos.prg"
/*
   txtfile.c

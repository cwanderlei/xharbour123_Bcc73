 ...
 * Generated C source code from <D:\\hwgui_2_17\\source\\hshbtn.prg>
 * Command: -ohshbtn.c -m -n -p -q -gc0 -ID:\hwgui_2_17\include -ID:\xharbour123_Bcc73\include D:\hwgui_2_17\source\hshbtn.prg 
...
#define __PRG_SOURCE__ "D:\\hwgui_2_17\\source\\hshbtn.prg"
...
HB_FUNC_STATIC( HSHADEBUTTON_PAINT )
{
   static const BYTE pcode[] =
   {
	13,4,0,102,80,1,133,58,0,108,25,100,12,0,
...
HB_FUNC_STATIC( HSHADEBUTTON_END )
{
   static const BYTE pcode[] =
   {
	13,1,0,102,80,1,133,83,0,48,35,0,48,20,
	0,95,1,112,0,112,0,73,134,1,108,36,100,48,
	24,0,95,1,112,0,20,1,134,3,100,110,7
   };

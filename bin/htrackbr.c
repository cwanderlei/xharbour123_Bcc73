 ...
 * Generated C source code from <D:\\hwgui_2_17\\source\\htrackbr.prg>
 * Command: -ohtrackbr.c -m -n -p -q -gc0 -ID:\hwgui_2_17\include -ID:\xharbour123_Bcc73\include D:\hwgui_2_17\source\htrackbr.prg 
...
#define __PRG_SOURCE__ "D:\\hwgui_2_17\\source\\htrackbr.prg"
...
{ "HWG_INITTRACKBAR", {HB_FS_PUBLIC | HB_FS_LOCAL}, {HB_FUNCNAME( HWG_INITTRACKBAR )}, &ModuleFakeDyn },
...
{ "HWG_TRACKBARSETRANGE", {HB_FS_PUBLIC | HB_FS_LOCAL}, {HB_FUNCNAME( HWG_TRACKBARSETRANGE )}, &ModuleFakeDyn },
...
HB_FUNC_STATIC( HTRACKBAR_NEW )
{
   static const BYTE pcode[] =
   {
	13,1,19,102,80,20,133,49,0,95,18,100,8,28,
...
HB_FUNC_STATIC( HTRACKBAR_ACTIVATE )
{
   static const BYTE pcode[] =
   {
	13,1,0,102,80,1,133,74,0,108,37,100,48,17,
	...
	4,48,49,0,95,1,112,0,73,134,7,100,110,7
   };
...
HB_FUNC_STATIC( HTRACKBAR_ONEVENT )
{
   static const BYTE pcode[] =
   {
	...
	95,4,112,1,73,134,3,121,110,7,134,5,95,1,
	93,0,2,8,28,33,134,6,48,52,0,95,4,112,
	0,100,69,29,1,1,134,7,108,53,100,48,52,0,
	95,4,112,0,20,1,26,240,0,134,9,95,1,92,
	20,8,28,83,134,10,48,54,0,95,4,112,0,100,
	69,29,217,0,134,11,108,55,100,48,17,0,95,4,
	112,0,12,1,80,5,134,13,108,56,100,95,2,95,
	5,122,1,95,5,92,2,1,95,5,92,3,1,128,
	1,0,95,5,92,4,1,128,1,0,48,17,0,48,
	54,0,95,4,112,0,112,0,20,6,134,14,122,110,
	7,134,16,95,1,92,2,8,28,15,134,17,48,57,
	0,95,4,112,0,73,26,128,0,134,18,95,1,93,
	2,1,8,28,52,134,19,95,2,92,9,5,28,108,
	134,21,108,58,100,48,38,0,95,4,112,0,48,17,
	0,95,4,112,0,100,108,59,100,9,120,12,2,28,
	6,92,255,25,3,122,20,4,134,22,121,110,7,134,
	24,95,1,93,0,1,5,28,20,134,25,108,60,100,
	95,4,95,2,12,2,28,44,134,26,121,110,7,134,
	28,48,61,0,95,4,112,0,100,69,28,26,134,29,
	48,51,0,48,61,0,95,4,112,0,95,4,95,1,
	95,2,95,3,112,4,110,7,134,32,92,255,110,7
   };
...
HB_FUNC_STATIC( HTRACKBAR_INIT )
{
   static const BYTE pcode[] =
   {
	13,1,0,102,80,1,133,121,0,48,62,0,95,1,
	...
	20,4,134,4,48,50,0,95,1,112,0,100,69,28,
	43,134,5,48,65,0,95,1,122,112,1,73,134,6,
	108,66,100,48,17,0,95,1,112,0,95,1,20,2,
	134,7,108,67,100,48,17,0,95,1,112,0,20,1,
	134,11,100,110,7
   };
...
HB_FUNC_STATIC( HTRACKBAR_SETVALUE )
{
   static const BYTE pcode[] =
   {
	13,1,1,102,80,2,133,135,0,108,30,100,95,1,
...
HB_FUNC_STATIC( HTRACKBAR_GETVALUE )
{
   static const BYTE pcode[] =
   {
	13,1,0,102,80,1,133,143,0,48,29,0,95,1,
	108,16,100,48,17,0,95,1,112,0,93,0,4,121,
	121,12,4,112,1,73,134,2,48,64,0,95,1,112,
	0,110,7
   };
...
#line 148 "D:\\hwgui_2_17\\source\\htrackbr.prg"

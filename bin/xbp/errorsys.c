 ...
 * Generated C source code from <\\hwgui\\source\\errorsys.prg>
 * Command: -oxbp\errorsys.c -m -n -pOxbp\ -q -gc0 -ID:\xharbour123_Bcc73\include -ID:\hwgui\include -ID:\xharbour123_Bcc73\include \hwgui\source\errorsys.prg 
 * Created: 2020.09.03 14:41:06 (Borland/Embarcadero C++ 7.3 (32-bit))
 */

#include "hbvmpub.h"
#include "hbinit.h"

#define __PRG_SOURCE__ "\\hwgui\\source\\errorsys.prg"

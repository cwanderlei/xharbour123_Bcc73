 ...
 * Generated C source code from <\\hwgui\\source\\hprogres.prg>
 * Command: -oxbp\hprogres.c -m -n -pOxbp\ -q -gc0 -ID:\xharbour123_Bcc73\include -ID:\hwgui\include -ID:\xharbour123_Bcc73\include \hwgui\source\hprogres.prg 
 * Created: 2020.09.03 14:41:32 (Borland/Embarcadero C++ 7.3 (32-bit))
 */

#include "hbvmpub.h"
#include "hbinit.h"

#define __PRG_SOURCE__ "\\hwgui\\source\\hprogres.prg"
...
HB_FUNC_STATIC( HPROGRESSBAR_NEWBOX )
{
   static const BYTE pcode[] =
   {
	...
	100,100,9,100,100,100,112,19,112,1,73,48,54,0,
	48,55,0,95,10,112,0,106,11,58,58,76,97,98,
	101,108,66,111,120,0,112,1,73,134,23,95,8,100,
	69,28,19,134,24,48,56,0,48,57,0,95,10,112,
	0,95,8,112,1,73,134,27,48,42,0,48,57,0,
	95,10,112,0,120,100,100,112,3,73,134,29,48,58,
	0,95,10,48,59,0,95,10,112,0,112,1,73,134,
	30,48,60,0,95,10,121,112,1,73,134,31,48,42,
	0,95,10,112,0,73,134,32,48,61,0,48,57,0,

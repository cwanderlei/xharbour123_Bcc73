 ...
 * Generated C source code from <\\hwgui\\source\\video.prg>
 * Command: -oxbp\video.c -m -n -pOxbp\ -q -gc0 -ID:\xharbour123_Bcc73\include -ID:\hwgui\include -ID:\xharbour123_Bcc73\include \hwgui\source\video.prg 
 * Created: 2020.09.03 14:41:55 (Borland/Embarcadero C++ 7.3 (32-bit))
 */

#include "hbvmpub.h"
#include "hbinit.h"

#define __PRG_SOURCE__ "\\hwgui\\source\\video.prg"

 ...
 * Generated C source code from <D:\\hwgui_2_17\\source\\video.prg>
 * Command: -ovideo.c -m -n -p -q -gc0 -ID:\hwgui_2_17\include -ID:\xharbour123_Bcc73\include D:\hwgui_2_17\source\video.prg 
...
#define __PRG_SOURCE__ "D:\\hwgui_2_17\\source\\video.prg"
...
HB_FUNC( TVIDEO )
{
   static const BYTE pcode[] =
   {
	...
	133,20,0,48,6,0,103,1,0,100,100,95,2,106,
	...
	9,112,4,73,134,7,48,7,0,103,1,0,106,9,
	73,110,105,116,105,97,116,101,0,108,10,14,95,2,
	9,112,4,73,134,8,48,11,0,103,1,0,106,5,
...
HB_FUNC_STATIC( TVIDEO_NEW )
{
   static const BYTE pcode[] =
   {
	13,1,8,102,80,9,133,36,0,95,3,100,8,28,
...
HB_FUNC_STATIC( TVIDEO_REDEFINE )
{
   static const BYTE pcode[] =
   {
	13,1,5,102,80,6,133,62,0,48,45,0,95,6,
...
HB_FUNC_STATIC( TVIDEO_INITIATE )
{
   static const BYTE pcode[] =
   {
	13,1,0,102,80,1,133,76,0,48,49,0,48,50,

 ...
 * Generated C source code from <D:\\hwgui_2_17\\source\\hrebar.prg>
 * Command: -ohrebar.c -m -n -p -q -gc0 -ID:\hwgui_2_17\include -ID:\xharbour123_Bcc73\include D:\hwgui_2_17\source\hrebar.prg 
...
#define __PRG_SOURCE__ "D:\\hwgui_2_17\\source\\hrebar.prg"
...
HB_FUNC_STATIC( HREBAR_NEW )
{
   static const BYTE pcode[] =
   {
	13,1,16,102,80,17,133,47,0,95,8,80,8,134,
	2,95,16,100,8,28,5,9,80,16,134,3,108,28,
	100,95,3,100,8,28,5,121,25,5,93,0,4,97,
	0,0,0,64,12,2,80,3,134,5,48,2,0,48,
	29,0,95,17,112,0,95,1,95,2,95,3,95,4,
	95,5,95,6,95,7,95,9,95,10,95,11,95,12,
	95,13,95,14,95,15,112,14,73,134,6,48,30,0,
	95,17,106,1,0,112,1,73,134,7,108,31,100,20,
	0,134,9,48,32,0,95,17,112,0,73,134,11,95,
	17,110,7
   };
...
HB_FUNC_STATIC( HREBAR_REDEFINE )
{
   static const BYTE pcode[] =
   {
	13,1,11,102,80,12,133,63,0,95,3,80,3,134,
...
HB_FUNC_STATIC( HREBAR_ACTIVATE )
{
   static const BYTE pcode[] =
   {
	13,1,0,102,80,1,133,76,0,108,38,100,48,15,
	0,48,39,0,95,1,112,0,112,0,12,1,31,81,
	134,2,48,40,0,95,1,108,41,100,48,15,0,48,
	...
	3,48,48,0,95,1,112,0,73,134,6,100,110,7
   };
...
HB_FUNC_STATIC( HREBAR_INIT )
{
   static const BYTE pcode[] =
   {
	13,1,0,102,80,1,133,86,0,48,49,0,95,1,
...
HB_FUNC_STATIC( HREBAR_CREATEBANDS )
{
   static const BYTE pcode[] =
   {
	13,2,6,102,80,7,133,97,0,95,1,100,69,28,

 ...
 * Generated C source code from <D:\\hwgui_2_17\\source\\hipedit.prg>
 * Command: -ohipedit.c -m -n -p -q -gc0 -ID:\hwgui_2_17\include -ID:\xharbour123_Bcc73\include D:\hwgui_2_17\source\hipedit.prg 
...
#define __PRG_SOURCE__ "D:\\hwgui_2_17\\source\\hipedit.prg"
...
HB_FUNC_STATIC( HIPEDIT_ACTIVATE )
{
   static const BYTE pcode[] =
   {
	13,1,0,102,80,1,133,75,0,108,41,100,48,42,
...
HB_FUNC_STATIC( HIPEDIT_INIT )
{
   static const BYTE pcode[] =
   {
	13,1,0,102,80,1,133,84,0,48,52,0,95,1,
...
HB_FUNC_STATIC( HIPEDIT_SETVALUE )
{
   static const BYTE pcode[] =
   {
	13,1,1,102,80,2,133,93,0,108,56,100,48,42,
...
HB_FUNC_STATIC( HIPEDIT_GETVALUE )
{
   static const BYTE pcode[] =
   {
	13,1,0,102,80,1,133,99,0,48,29,0,95,1,
...
HB_FUNC_STATIC( HIPEDIT_CLEAR )
{
   static const BYTE pcode[] =
   {
	13,1,0,102,80,1,133,103,0,108,58,100,48,42,
...
HB_FUNC_STATIC( HIPEDIT_END )
{
   static const BYTE pcode[] =
   {
	13,1,0,102,80,1,133,111,0,48,59,0,48,26,
...
HB_FUNC_STATIC( __GETFOCUS )
{
   static const BYTE pcode[] =
   {
	13,1,1,133,119,0,108,60,100,95,1,9,12,2,
...
HB_FUNC_STATIC( __KILLFOCUS )
{
   static const BYTE pcode[] =
   {
	13,1,1,133,137,0,108,60,100,95,1,120,12,2,

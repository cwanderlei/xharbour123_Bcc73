 ...
 * Generated C source code from <D:\\hwgui_2_17\\source\\hnice.prg>
 * Command: -ohnice.c -m -n -p -q -gc0 -ID:\hwgui_2_17\include -ID:\xharbour123_Bcc73\include D:\hwgui_2_17\source\hnice.prg 
...
#define __PRG_SOURCE__ "D:\\hwgui_2_17\\source\\hnice.prg"
...
{ "HWG_NICEBUTTPROC", {HB_FS_PUBLIC | HB_FS_LOCAL | HB_FS_FIRST}, {HB_FUNCNAME( HWG_NICEBUTTPROC )}, &ModuleFakeDyn },
...
{ "HWG_SETNICEBTNSELECTED", {HB_FS_PUBLIC | HB_FS_LOCAL}, {HB_FUNCNAME( HWG_SETNICEBTNSELECTED )}, &ModuleFakeDyn },
...
HB_FUNC( HWG_NICEBUTTPROC )
{
   static const BYTE pcode[] =
   {
	13,1,4,133,132,0,95,2,122,69,29,198,0,134,
...
HB_FUNC_STATIC( HNICEBUTTON_CREATE )
{
   static const BYTE pcode[] =
   {
	13,5,0,102,80,1,133,165,0,108,77,100,48,55,
...
HB_FUNC_STATIC( HNICEBUTTON_SIZE )
{
   static const BYTE pcode[] =
   {
	13,1,0,102,80,1,133,176,0,48,81,0,95,1,
...
HB_FUNC_STATIC( HNICEBUTTON_MOVING )
{
   static const BYTE pcode[] =
   {
	13,1,0,102,80,1,133,183,0,48,81,0,95,1,
...
HB_FUNC_STATIC( HNICEBUTTON_MOUSEMOVE )
{
   static const BYTE pcode[] =
   {
	13,2,2,102,80,3,133,192,0,95,1,80,1,134,
...
HB_FUNC_STATIC( HNICEBUTTON_MUP )
{
   static const BYTE pcode[] =
   {
	13,1,0,102,80,1,133,219,0,48,83,0,95,1,
...
HB_FUNC_STATIC( HNICEBUTTON_MDOWN )
{
   static const BYTE pcode[] =
   {
	13,1,0,102,80,1,133,237,0,48,83,0,95,1,
...
HB_FUNC_STATIC( HNICEBUTTON_PAINT )
{
   static const BYTE pcode[] =
   {
	13,12,0,102,80,1,133,249,0,108,89,100,12,0,
...
HB_FUNC_STATIC( HNICEBUTTON_END )
{
   static const BYTE pcode[] =
   {
	13,1,0,102,80,1,133,41,1,100,110,7
   };
...
HB_FUNC_STATIC( HNICEBUTTON_RELEASE )
{
   static const BYTE pcode[] =
   {
	13,1,0,102,80,1,133,45,1,48,21,0,95,1,
...
HB_FUNC( HWG_SETNICEBTNSELECTED )
{
   static const BYTE pcode[] =
   {
	13,1,1,133,55,1,48,99,0,108,1,100,12,0,
